                        ...
                        <div class="submit-field">
                            ...
                            <div class="keywords-container">
                                <div class="keyword-input-container">
                                    {{-- here we use implode method to convert array to string --}}
                    ...
                    <div class="col-xl-12">
                        <div class="submit-field">
                            ...
                            <div class="uploadButton margin-top-30">
                                {{-- here put the name of felid attachments[] in order to accpet more value --}}
                                ...
                                <div>
                                    <ul>
                                        @foreach ($project->attachments as $file)
                                            {{-- here basename() return just name of file --}}
