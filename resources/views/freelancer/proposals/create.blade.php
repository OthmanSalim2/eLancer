                        ...
                        <div class="left-side">
                            ...
                            <div class="header-details">
                                ...
                                <ul>
                                    ...
                                    <li><img class="flag" src="images/flags/gb.svg" alt=""> United Kingdom
                                    </li>
                                    <li>
                            ...
                            <div class="job-overview-inner">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <h5>{{ \Carbon\Carbon::parse($project->created_at)->diffForHumans() }}</h5>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sign-in-form">
            ...
            <div class="popup-tabs-container">
                ...
                <div class="popup-tab-content" id="tab">
                    ...
                    <!-- Form -->
                    <form method="post" action="{{ route('freelancer.proposals.store', $project->id) }}"
                        id="apply-now-form">
                        @csrf
                        ...
                        <div class="input-with-icon-left">
                            ...
                            <x-form.input type="number" class="input-text with-border" name="cost"
                                id="cost" placeholder="Cost" required="required" />
                        </div>

                        <div class="input-with-icon-left">
                            <i class="icon-material-baseline-mail-outline"></i>
                            <x-form.input type="number" class="input-text with-border" name="duration"
                                id="duration" placeholder="Duration" required="required" />
